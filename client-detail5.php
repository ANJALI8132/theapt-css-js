...
<head>
    <meta charset="utf-8">
    <title>Pharma Deal</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Pharma Deal is a Melbourne, Australia based cosmetic and pharmaceutical e-Commerce website with both physical and online store. Their digital marketing agenda was to increase sales.">
    <meta name="keywords" content="Pharma Deal">
    ...
    <!-- <meta property="og:title" content="Pharma Deal" />
    <meta property="og:description" content="Pharma Deal is a Melbourne, Australia based cosmetic and pharmaceutical e-Commerce website with both physical and online store. Their digital marketing agenda was to increase sales." />
...
<img src="images/client/8.png" title="Pharma Deal" alt="Pharma Deal">
</div>
</div>
<div class="col-lg-9 ">
<div class="cldt_info" >
...
<h4>Pharma Deal </h4>
<p>Pharma Deal is a Melbourne, Australia based cosmetic and pharmaceutical e-Commerce website with both physical and online store. Their digital marketing agenda was to increase sales.</p>
</div>
...
<h4>30%</h4> <p>Increase in Sales</p>
</div>
</div>
</div>
...
<div class="cldt_count">
<div class="cldt_count_in">
<h4>120%</h4> <p>Increase in Site visit</p>
</div>
</div>
</div>
...
<div class="cldt_count">
<div class="cldt_count_in">
<h4>40%</h4> <p>Increase in Social Media Engagements</p>
</div>
</div>
</div>
...
<h5>Scope</h4>
<ul class="inr_bult">
<li>Secure increased sales from regions across Australia</li>
<li>Achieve sales traction from new customers</li>
</ul>
</div>
...
<h5>Challenges</h4>
<ul class="inr_bult">
<li>Extremely competitive market</li>
<li>Inadequate trust in the brand</li>
</ul>
</div>
...
<h5>Our Solution</h4>
<ul class="inr_bult">
<li>Facebook engagement campaigns were activated to build brand recall</li>
<li>Google shopping Ads, Facebook Shopping and Catalog Ads were put out</li>
<li>Dynamic remarketing techniques were employed</li>
<li>Google Search Ads and Display Ads were used</li>
<li>SEO to bring organic scale up was extensively used</li>
</ul>
</div>
